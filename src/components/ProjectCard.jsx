...
const ProjectCard = ({ project, onSeeMore }) => {
  ...
  return (
    <div ref={ref} className="project-card group bg-card shadow-lg border-2 border-border rounded-xl p-4 md:p-6 m-4 flex flex-col w-[90%] mx-auto transition-all duration-300 md:hover:shadow-2xl md:hover:scale-105 md:hover:border-primary/80 hide md:animate-slide-left show">
