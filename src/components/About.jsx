...
const About = () => {
  ...
  return (
    <div id='about' className="min-h-screen flex items-center justify-center p-8 transition-all duration-500 z-20">
      <div ref={ref} className="max-w-4xl w-full bg-card bg-opacity-90 backdrop-filter backdrop-blur-lg rounded-xl shadow-2xl p-10 border-2 border-border transition-all duration-500 ease-in-out md:hover:shadow-3xl md:hover:scale-105 md:hover:border-primary/80 z-10 hide animate-zoom-in">
        <h1 className="sm:text-5xl text-4xl font-bold text-htag mb-8 md:text-start text-center">
          ...
          <span id="wave" className='hidden md:inline'>👋</span>
        </h1>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start mb-12">
          ...
          <div className="flex-1 text-center md:text-left">
            <p className="text-lg text-ptag mb-4">
              I am a full-stack developer passionate about improving user experiences. My journey in tech has provided me with real world experience across the development lifecycle—from managing projects and designing user flows to crafting sleek UIs, creative backend solutions, and thoughtful APIs.
            </p>
