...
export default function CareerTimeline() {
	...
	return (
		<section
			id="career"
			className="py-section bg-gradient-to-b from-gray-900/80 to-black"
		>
					...
					<div className="relative space-y-6">
						...
						{experiences.map((experience, index) => (
							...
							>
								...
								<div className="glass glass-hover rounded-xl border border-border p-4">
						...
						{experiences.map((experience, index) => (
							...
							>
								<motion.div
									...
									viewport={{ once: true, amount: 0.3 }}
								>
									<div className="glass glass-hover rounded-xl border border-border p-6">
